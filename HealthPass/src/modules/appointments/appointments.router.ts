...
// Appointments
router.post('/', validate(bookAppointmentSchema), appointmentsController.book);
router.get('/', appointmentsController.list);
router.get('/:id', validate(appointmentIdSchema), appointmentsController.detail);
router.patch('/:id/cancel', validate(cancelSchema), appointmentsController.cancel);
router.patch('/:id/reschedule', validate(rescheduleSchema), appointmentsController.reschedule);
